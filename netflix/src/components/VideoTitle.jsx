...
const VideoTitle = ({title, overview}) => {
  return (
    <>
    <div className='w-screen aspect-video pt-[30%] md:pt-72 lg:pt-[18%] px-10 md:px-20 absolute text-white bg-gradient-to-r from-black'>
    <h1 className='text-[35px] leading-tight w-52 md:w-80 md:text-[50px] font-bold'>{title} </h1>
    <p className='py-6 md:inline-block text-sm w-80'>{overview}</p>
